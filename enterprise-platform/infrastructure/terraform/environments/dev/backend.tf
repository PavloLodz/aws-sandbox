...
#   key        = "dev/terraform.tfstate"   # unique per environment — never share a key between envs
...
#
#   address        = "https://gitlab.example.com/api/v4/projects/<id>/terraform/state/dev"
#   lock_address   = "https://gitlab.example.com/api/v4/projects/<id>/terraform/state/dev/lock"
#   unlock_address = "https://gitlab.example.com/api/v4/projects/<id>/terraform/state/dev/lock"
#
